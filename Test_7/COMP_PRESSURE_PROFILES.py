...
#ELECTROSTATICS
print("ELEC TOT:      %e"%(np.mean(C[:,5]+np.sum(C[:,5:],axis=1)/3.)))
print("ELEC0:         %e"%(np.mean(C[:,5]))) 
print("ELEC1 xx:      %e"%(np.mean(C[:,6])))
print("ELEC1 yy:      %e"%(np.mean(C[:,7])))
print("ELEC1 zz:      %e"%(np.mean(C[:,8])))
